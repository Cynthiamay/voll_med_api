...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioLivreNaData() {
        ...
        var proximaSegundaAsDez = LocalDate.now()
                ...
                .atTime(10, 0);
        var medico = cadastrarMedico("", "medico@voll.med", "12344", Especialidade.cardiologia);
        var paciente = cadastrarPaciente("oi", "", "12312312312");
    ...
    @Test
    @DisplayName("Deveria devolver meidco quando disponivel na data")
